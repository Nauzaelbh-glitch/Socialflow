      ...
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-white border-r border-gray-200 transition-all duration-300 flex flex-col`}>
        <div className="h-16 flex items-center px-4 border-b border-gray-200">
          {sidebarOpen ? (
            ...
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center mx-auto shadow-lg shadow-violet-500/25">
              <Share2 className="w-5 h-5 text-white" />
            </div>
          )}
        </div>
        ...
        <nav className="flex-1 p-4 space-y-2">
          {[
            ...
            { icon: Send, label: 'Publicaciones', active: false },
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6">
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              <input 
                type="text"
                placeholder="Buscar publicaciones, cuentas..."
                className="w-80 pl-10 pr-4 py-2 bg-gray-100 border-0 rounded-xl focus:ring-2 focus:ring-violet-500 focus:bg-white transition-all"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>{currentTime.toLocaleDateString('es-ES', { weekday: 'short', day: 'numeric', month: 'short' })}</span>
            </div>
            <button className="relative p-2 hover:bg-gray-100 rounded-lg transition-colors">
              <Bell className="w-5 h-5 text-gray-600" />
              <span className="absolute top-1 right-1 w-2 h-2 bg-red-500 rounded-full"></span>
            </button>
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-white font-semibold">
              N
            </div>
          </div>
        </header>
